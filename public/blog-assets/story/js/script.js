...
trainingPotty: {
    cards: [
      ...
      { type:'info', icon:'paw', img: 'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/training/training6/s_image10.webp', title:'Accidents Are Normal', body:'Young puppies are still learning to control their bladder.\nAccidents are a normal part of growing up.' },
...
trainingEarly: {
  ...
  vaccinations: {
    cards: [
      ...
      { type:'summary', img:'images/CARD 11 — Continue Learning.png',
        ...
        recoImg: 'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d1.webp',
  ...
  deworming: {
    cards: [
      ...
      { type:'info', icon:'bug', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d10.webp', title:'What Are Worms?',
 ...
 feeding: {
  ...
  drinking: {
    cards: [
      ...
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d1.webp', eyebrow:'PETOLIFE PET PARENT ACADEMY', title:'How Often Should You Change Your Dog\'s Drinking Water?', body:'Food is important.\nBut fresh, clean drinking water is just as important for your dog\'s health.', author:true },
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d2.webp', title:'Water Keeps Your Dog Healthy', body:'Your dog\'s body needs water every day to stay healthy, active, and hydrated.' },
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d3.webp', title:'Clean Water Matters', body:'Dust, saliva, food particles, and dirt can collect in the water bowl during the day.\nFresh water is always the better choice.' },
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d4.webp', title:'Make It a Daily Habit', body:'Replace your dog\'s drinking water with clean, fresh water every day.\nWash the bowl regularly to keep it clean.' },
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d5.webp', title:'Dogs Drink More in Summer', body:'During hot weather or after exercise, dogs usually drink more water.\nAlways make sure fresh water is available.' },
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d6.webp', title:'Notice Your Dog\'s Drinking Habits', body:'If your dog suddenly drinks much more or much less than usual, talk to your veterinarian.' },
      { type:'info', icon:'paw', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d7.webp', title:'Never Let the Bowl Stay Empty', body:'Always make sure your dog has access to clean drinking water throughout the day.' },
      { type:'survey', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d8.webp', title:'📝 Tell Us About Your Dog\nHow often do you change your dog\'s drinking water?', options:['💧 More than once a day', '💧 Once a day', '💧 Every two days', '🤔 Only when the bowl is empty'], responses:['Excellent! Fresh water is best.', 'Good habit!', 'Try changing it daily for better hygiene.', 'It\'s best to change it daily even if not empty.'] },
      ...
      { type:'summary', img: 'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/training/training1/training1(1).webp', title:'🎉 Great Job!', body:'You just completed "How Often Should You Change Your Dog\'s Drinking Water?"', recoImg: 'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/care/exercise/eimage1.webp', recoTitle:'How Much Exercise Does Your Dog Need Every Day?', recoRead:'1 min read', recoStory:'exercise' }
    ]
  },
  ...
  birds_feeding: {
    cards: [
      ...
      { type:'quiz', img: 'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/training/training1/training1(1).webp', title:'Quick Check ✅', question:'Which statement is true?', options:['Most pet birds need more than just seeds.', 'Seeds are enough for every bird.', 'Birds don\'t need fresh water every day.', 'Human snacks are safe for birds.'], answer:0 },
  ...
  cats_vaccinations: {
    cards: [
      ...
      { type:'summary', img:'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/vaccination/cvimage9.webp', title:'🎉 Great Job!', body:'You just completed\nWhy Do Cats Need Vaccinations?', recoImg: 'https://petolife-blog-images-141927126120-ap-south-1-an.s3.ap-south-1.amazonaws.com/health%26prevention/deworming/d1.webp', recoTitle:'Why Do Dogs Need Regular Deworming?', recoRead:'1 min read', recoStory:'deworming' }
    ]
  },
  cats_feeding: {
    cards: [
...
function buildSlides(){
  ...
  CARDS.forEach((c, i) => {
    ...
    if (c.type === 'survey' || c.type === 'poll' || c.type === 'quiz'){
      ...
      const questionText = c.question ? `${c.title}<br/><span style="font-size:0.9em;font-weight:normal;opacity:0.9;display:block;margin-top:8px;">${c.question}</span>` : c.title;

      div.innerHTML = `
        ${sceneHtml}
        <div class="panel">
          <div class="eyebrow eyebrow-dark">${c.type === 'quiz' ? 'QUICK CHECK' : 'QUICK SURVEY'}</div>
...
document.getElementById('shareBtn').addEventListener('click', () => {
  ...
  const numericId = storyIdMap[sId] || sId;
